	...
	<table>
        ...
        <tbody>
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
    				...
    				<td class="file">
                        <?php if( $vol["hasfile"] == 1): ?>【<a href="/tp3/index.php/Admin/Email/download/id/<?php echo ($vol["id"]); ?>">下载</a>】
                            <?php echo ($vol["filename"]); endif; ?>
                    </td>
                    ...
                    <td class="operate">
                    	<a href ='javascript:;' class="content" data-title="<?php echo ($vol["title"]); ?>" data-id="<?php echo ($vol["id"]); ?>">查看</a> 
                    </td>
...
$(function(){
    $('.content').on('click',function(){
        ...
        layer.open({
            ...
            area: ['800px', '500px'],
            content: '/tp3/index.php/Admin/Email/getContent/id/'+id,
            end: function(){
